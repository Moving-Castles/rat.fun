...
export const enUS = {
  ...
  adminInstruction: (price: number) =>
    `Unlock access to our rat-a-licious TRIP LAB for ${price} ${CURRENCY_SYMBOL}.<br>Lets you create bespoke TRIPS through a Bloomberg-style terminal for the mentally deranged.<br>Results may vary.`,
  action: "Action",
  all: "All",
  amountToAdd: "Amount to add",
  activeProfit: "Active profit",
  adminUnlocked: "Admin unlocked",
  adminUnlockedMessage: "You unlocked the TRIP LAB",
  ago: "ago",
  alive: "Alive",
  active: "Active",
  ...
  locked: "locked",
  masterKey: "TRIP LAB unlocked",
  maxReward: "REWARD",
  maxValuePerWin: "REWARD",
  maxValuePerWinLabel: "REWARD",
  messageCannotBeEmpty: "Message cannot be empty",
  minRatValueToEnter: "RISK",
  music: "Music",
  musicOn: "Music: ON",
  musicOff: "Music: OFF",
  minRatValueToTrip: "RISK",
  ...
  unlockAdmin: "Unlock TRIP LAB",
  unlockAdminInstruction: "Unlock TRIP LAB",
  unlockAdminLoading: "Unlocking TRIP LAB",
  unlock: "Unlock",
  unknown: "unknown",
  valueLabel: "VALUE",
  visits: "Visits",
