...
t he mentally deranged. Results may vary.`,
  ...
  player: "Player",
  playerId: "PLAYER ID:",
  psychoInventory: "PsychoObjects",
  past: "Past",
  pastTrips: "Past trips",
  profit: "Profit",
  portfolio: "Portfolio",
  psychoObjectExplanation:
    "PsychoObjects are materializations of mental items acquired tripping. Nobody really knows how they work, but they are 1000% real, definitely NOT hallucinations",
  rat: "Rat",
