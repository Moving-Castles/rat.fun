<script lang="ts">
  ...
  import { getModalState } from "$lib/components/Main/Modal/state.svelte"
  import ModalTarget from "$lib/components/Main/Modal/ModalTarget.svelte"

  import RatInfo from "$lib/components/Main/RatContainer/YourRat/RatInfo.svelte"
  import RatInventory from "$lib/components/Main/RatContainer/YourRat/RatInventory.svelte"
  import LiquidateRat from "$lib/components/Main/RatContainer/YourRat/LiquidateRat.svelte"
  import DeployRat from "$lib/components/Main/RatContainer/DeployRat/DeployRat.svelte"
