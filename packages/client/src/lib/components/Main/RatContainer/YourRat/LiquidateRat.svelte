<script lang="ts">
  ...
  import DangerButton from "$lib/components/Main/Shared/Buttons/DangerButton.svelte"

  import { ModalTarget, getModalState } from "$lib/components/Main/Modal/state.svelte"
