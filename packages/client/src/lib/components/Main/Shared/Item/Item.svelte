<script lang="ts">
	...
	import { ModalTarget } from '$lib/components/Main/Modal/state.svelte';
	import { getModalState } from '$lib/components/Main/Modal/state.svelte';
	import Spinner from '$lib/components/Main/Shared/Loaders/Spinner.svelte';

	import type { TempItem } from '$lib/components/Main/RoomResult/types';
