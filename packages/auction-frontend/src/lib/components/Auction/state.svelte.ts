...
const VALID_TRANSITIONS: Record<AUCTION_STATE, AUCTION_STATE[]> = {
  [AUCTION_STATE.INIT]: [AUCTION_STATE.CONNECT_WALLET, AUCTION_STATE.CHECKING, AUCTION_STATE.ENDED, AUCTION_STATE.ERROR],
  [AUCTION_STATE.CONNECT_WALLET]: [AUCTION_STATE.CHECKING, AUCTION_STATE.ENDED, AUCTION_STATE.ERROR],
  ...
  [AUCTION_STATE.AVAILABLE]: [AUCTION_STATE.ENDED, AUCTION_STATE.WALLET_LIMIT_REACHED, AUCTION_STATE.ERROR],
  [AUCTION_STATE.ENDED]: [],
