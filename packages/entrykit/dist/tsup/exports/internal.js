...
import { useConfig, useClient, useAccount, useConnectorClient, useChains, useBalance, useWatchBlockNumber, useDisconnect } from 'wagmi';
import { ConnectKitProvider, useModal } from 'connectkit';
import { parseAbi, http, isHex, parseEther, formatEther, encodeFunctionData, zeroAddress, parseErc6492Signature, toHex } from 'viem';
...
import { readContract, setBalance, waitForTransactionReceipt, writeContract, signTypedData } from 'viem/actions';
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "self-center flex flex-col gap-2 w-60", children: /* @__PURE__ */ jsx(WalletButton, {}) })
      ]
    }
  );
}
    ...
    queryFn: async () => {
      ...
      const [funds, hasDelegation] = await Promise.all([
        ...
        queryClient.fetchQuery(
          getDelegationQueryOptions({ client, worldAddress, userAddress, sessionAddress })
        )
      ]);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "font-mono text-white", children: /* @__PURE__ */ jsx(TruncatedHex, { hex: userAddress }) })
      ] }),
      /* @__PURE__ */ jsx(
        Button,
        {
...
function ConnectedSteps({ connector, userClient, initialUserAddress }) {
  ...
  const steps = useMemo(() => {
    ...
    return steps2;
  }, [hasDelegation, hasGasBalance, paymaster, sessionAddress, userAddress, userClient, connector]);
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx(
              "div",
              {
                className: twMerge(
                  "flex flex-col",
                  isDisabled ? "opacity-30 pointer-events-none" : null
                ),
                children: content
              }
            )
...
function AccountButton() {
  ...
  return /* @__PURE__ */ jsx(Shadow, { mode: "child", children: isSignedIn ? /* @__PURE__ */ jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx("span", { className: "flex-grow inline-flex gap-2.5 items-center text-left font-medium", children: userAddress ? /* @__PURE__ */ jsx(TruncatedHex, { hex: userAddress }) : null })
    },
    "connected"
  ) : /* @__PURE__ */ jsxs(
    "button",
...
export { AccountButton, EntryKitProvider, createBundlerClient, defineCall, defineConfig, getBundlerTransport, getFundsQueryOptions, internal_validateSigner, useAccountModal, useEntryKitConfig, useFunds, useSessionClientReady as useSessionClient };
