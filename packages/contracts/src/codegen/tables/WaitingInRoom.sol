...
library WaitingInRoom {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratroom", name: "WaitingInRoom", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726174726f6f6d0000000000000057616974696e67496e526f6f6d000000);
