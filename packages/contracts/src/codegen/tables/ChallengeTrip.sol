...
library ChallengeTrip {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "ChallengeTrip", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004368616c6c656e676554726970000000);
