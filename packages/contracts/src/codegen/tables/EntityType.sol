...
library EntityType {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratlab", name: "EntityType", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627261746c61620000000000000000456e7469747954797065000000000000);
