...
library FixedMinValueToEnter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "FixedMinValueToE", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e000000000000000046697865644d696e56616c7565546f45);
