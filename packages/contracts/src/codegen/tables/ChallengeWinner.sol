...
library ChallengeWinner {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "ChallengeWinner", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004368616c6c656e676557696e6e657200);
