...
library Liquidated {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "Liquidated", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004c697175696461746564000000000000);
