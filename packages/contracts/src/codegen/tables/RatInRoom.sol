...
library RatInRoom {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratroom", name: "RatInRoom", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726174726f6f6d00000000000000526174496e526f6f6d00000000000000);
