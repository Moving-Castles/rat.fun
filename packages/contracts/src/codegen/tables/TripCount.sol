...
library TripCount {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "TripCount", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e000000000000000054726970436f756e7400000000000000);
