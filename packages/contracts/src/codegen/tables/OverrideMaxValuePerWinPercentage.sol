...
library OverrideMaxValuePerWinPercentage {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratfun", name: "OverrideMaxValue", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746272617466756e00000000000000004f766572726964654d617856616c7565);
