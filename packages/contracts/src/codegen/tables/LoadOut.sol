...
library LoadOut {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ratroom", name: "LoadOut", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726174726f6f6d000000000000004c6f61644f7574000000000000000000);
