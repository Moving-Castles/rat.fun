import type { TerminalOutputUnit, PlaySoundFn } from "./types.js"

export type { TerminalOutputUnit, PlaySoundFn }
  ...
  const controller = {
    ...
    promise: (async () => {
      for (const unit of units) {
        if (isStopped) break
        await typeUnit(targetElement, unit, () => isStopped, playSound)
      }
    })()
  }
