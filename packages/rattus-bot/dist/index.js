...
var IWorld_abi_default = [
  ...
  {
    type: "function",
    name: "ratfun__setChallengeConfig",
    inputs: [
      {
        name: "_minCreationCost",
        type: "uint256",
        internalType: "uint256"
      },
      {
        name: "_activePeriodBlocks",
        type: "uint32",
        internalType: "uint32"
      }
    ],
...
var mud_config_default = defineWorld({
  ...
  tables: {
    ...
    ChallengeConfig: {
      key: [],
      schema: {
        minCreationCost: "uint256",
        // Minimum cost to create a challenge trip (5000)
        activePeriodBlocks: "uint32"
        // Blocks challenge is active (43200 = 24h at 2s/block)
      }
    },
